...
export default function PerfilPage() {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col gap-6 px-4 py-12 sm:px-6">
      ...
      <dl className="flex flex-col gap-3 rounded-2xl border border-neutral-200 bg-white p-5 text-sm">
      ...
      <button
        ...
        className="rounded-full border border-neutral-300 px-4 py-2.5 text-sm font-medium text-neutral-700 transition-colors hover:border-neutral-900 hover:text-neutral-900"
      >
        Cerrar sesión
      </button>
    </div>
